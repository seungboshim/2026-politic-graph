...
export const TYPES: PoliticalType[] = [
  ...
  {
    id: 'pd-labor', name: 'PD 노동좌파', nickLabel: '노동좌파', camp: '좌파',
  ...
  {
    id: 'prosec-reform', name: '검찰개혁 운동파', nickLabel: '검찰개혁', camp: '중도좌',
  ...
  {
    id: 'moderate-lib', name: '온건 자유주의', nickLabel: '온건자유', camp: '중도좌',
  ...
  {
    id: 'pro-impeach-con', name: '찬탄 개혁보수', nickLabel: '찬탄보수', camp: '우파',
  ...
  {
    id: 'anti-impeach-main', name: '반탄 당권 주류', nickLabel: '반탄주류', camp: '우파',
  ...
  {
    id: 'plaza-right', name: '광장 우파', nickLabel: '광장우파', camp: '우파',
  ...
  {
    id: 'apathy', name: '무관심층', nickLabel: '무관심', camp: '비이념',
