...
export const POLITICIANS: Politician[] = [
  // ─ 진보·민주 진영
  { id: 'lee-jm', name: '이재명', party: '더불어민주당', vector: { axes: { econ: -55, social: -20, security: -35, trust: -10, gender: -10, engage: E }, impeach: 'pro', fraud: 0, leejm: 0, prosec: 75 }, face: { sex: 'm', hair: 'down', hairColor: 'black', glasses: false }, tags: ['#이재명정부', '#개혁행보', '#당원주권'] },
  ...
  { id: 'jang-dh', name: '장동혁', party: '국민의힘', vector: { axes: { econ: 50, social: 50, security: 65, trust: 35, gender: 35, engage: E }, impeach: 'antiMild', fraud: 45, leejm: 95, prosec: 10 }, face: { sex: 'm', hair: 'down', hairColor: 'black', glasses: true }, tags: ['#장동혁지도부', '#선관위정국', '#정면돌파'] },
  // ─ 광장 우파
